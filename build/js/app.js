...
var mapModule = function () {
  ...
  var initMap = function initMap() {
    ...
    var infoContent = '<header>' + '<h6 class="map__header--above">Gabinet Stomatologiczny</h6>' + '<h5 class="map__header">Katarzyna Blabuś</h5>' + '</header>' + '<address>' + '<p class="map__address">Wrocławska 55,</p>' + '<p class="map__address">63-640 Bralin, Polska</p>' + '</address>';
    ...
    geocoder.geocode({
      'address': 'Wrocławska 55, 63-640 Bralin'
...
var navModule = function () {
  ...
  var addScrollClass = function addScrollClass() {
  ...
  var removeScrollClass = function removeScrollClass() {
    // Updateing nav classes
...
var scrollRevealConfig = function () {

  // Scroll Reveal Installation
  window.sr = ScrollReveal();

  // Methods
  var checkElementExist = function checkElementExist(elementName) {
    var el = document.querySelector(elementName);
    return typeof el != 'undefined' && el != null;
  };

  var initReveal = function initReveal(elementName, options) {
    if (checkElementExist(elementName)) {
      sr.reveal(elementName, options);
    }
  };

  // Reveals 
  //    initReveal('.nav__links', {
  //        duration: 1200,
  //        delay: 1000,
  //        origin: 'right',
  //        distance: '50vw'
  //    });
  initReveal('.head__header--above', {
    delay: 900,
    duration: 1000,
    origin: 'top'
  });
  initReveal('.head__logo', {
    duration: 1500,
    origin: 'right',
    distance: '40px'
  });
  initReveal('.head__header', {
    duration: 1000,
    origin: 'left',
    distance: '50vw'
  });
  initReveal('.head__desc', {
    delay: 900,
    duration: 1000
  });
  initReveal('.head .btn--default', {
    duration: 1000,
    delay: 1500
  ...
  initReveal('.pricelist', {
    vievFactor: 0.3,
    duration: 1700
  });
  initReveal('.contact__details>*', {
    duration: 1500,
    origin: 'left',
    distance: '5vw'

  });
  initReveal('.hours--contact>.row>*', {
    duration: 1500,
    origin: 'right',
    distance: '5vw',
    container: '.hours--contact>.row'
  });
}();
...
var jump = function () {
  ...
  var o = {
    ...
    _loop: function _loop(time) {
      ...
      this.timeElapsed < this.duration ? requestAnimationFrame(_loop2) : this._end();
    },
